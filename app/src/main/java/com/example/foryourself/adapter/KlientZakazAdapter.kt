...
class KlientZakazAdapter : RecyclerView.Adapter<KlientZakazAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: KlientZakazAdapter.ViewHolder, position: Int) {
